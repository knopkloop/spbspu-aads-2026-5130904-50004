...
namespace haliullin
{
  ...
  public:
    ...
    Vector< std::pair< std::string, Vector< unsigned long long > > > getOutbound(const std::string& fromVert) const;
    Vector< std::pair< std::string, Vector< unsigned long long > > > getInbound(const std::string& toVert) const;

...
namespace haliullin
{
  ...
  public:
    ...
    using EdgeTable = RobinHashTable< EdgeKey, double, detail::MurMurHash, std::equal_to< EdgeKey > >;
    ...
    double getEdge(const std::string& from, const std::string& to) const;
    ...
    Vector< std::pair< EdgeKey, double > > getAllEdges() const;
